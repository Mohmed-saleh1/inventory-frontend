  ...
  const chartData = {
    Week: {
      ...
      datasets: [
        {
          label: "Revenue",
          data: [0, 20000, 40000, 10000, 30000, 45000, 100000], // Daily revenue data for the week
      ...
      datasets: [
        {
          label: "Revenue",
          data: [
            120000, 130000, 150000, 140000, 160000, 170000, 180000, 190000,
            210000, 230000, 240000, 250000,
    ...
    Year: {
      ...
      datasets: [
        {
          label: "Revenue",
          data: [1000000, 1100000, 1200000, 1300000, 1200000], // Yearly revenue data
          borderColor: "rgba(75, 192, 192, 1)",
          backgroundColor: "rgba(75, 192, 192, 0.2)",
          fill: true,
        },
      ...
      y: {
        ...
        ticks: {
          callback: function (value) {
            return `$${value / 1000}k`; // Format y-axis
          },
    ...
    <div className="mt-6 shadow-lg flex flex-col px-10 pt-4 w-full rounded-2xl relative h-fit bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        {[
          ...
          <div
            key={index}
            className={`px-5 py-6 rounded-lg shadow-md ${card.bg}`}
          >
          ...
          <div>
            ...
            <div className="flex items-center justify-center gap-20">
              ...
              <p className="text-sm text-green-600">
                +3.4% <span className="text-gray-500">from last period</span>
              </p>
            </div>
          </div>
            ...
            {["Week", "Month", "Year"].map((period) => (
              <button
                ...
                className={`text-sm font-medium px-3 py-1 rounded-md ${
                  activePeriod === period
                    ? "text-blue-10"
                    : "text-gray-500 hover:text-blue-10 transition-all duration-500"
                }`}
              >
                {period}
              </button>
